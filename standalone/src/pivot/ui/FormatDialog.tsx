...
/** advanced-style Format dialog: number formats, cell rules and export furniture. */
          ...
          <div className="space-y-3 p-4">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        <label className="flex items-center gap-1.5 text-xs text-muted-foreground">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              patchFormat(index, { decimals: Number(e.target.value) })
                            }
                          />
                        </label>
                        <label className="flex items-center gap-1.5 text-xs text-muted-foreground">
            ...
            {tab === "conditional" && (
              <div data-testid="conditional-format-tab" className="space-y-2">
                <p className="text-xs text-muted-foreground">
                  Colour cells whose value matches a rule. Rules apply top to bottom; the first
                  match wins.
                </p>
