  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Combined column + line", flexmonster: y(), reactPivottable: n() },
      {
        ...
        flexmonster: p("Via conditional formatting"),
        reactPivottable: y(),
      },
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        flexmonster: y("Flexmonster Data Server"),
        reactPivottable: n(),
      },
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        flexmonster: y("Included with licence"),
    ...
    rows: [
      {
        ...
        flexmonster: n("Paid licence required"),
      ...
      { feature: "Source code available", flexmonster: n(), reactPivottable: y() },
      {
        ...
        flexmonster: y("from ~$799/yr"),
        reactPivottable: y("MIT"),
      },
      {
        feature: "SaaS / multi-tenant embedding licence",
        flexmonster: y("Paid tier"),
        reactPivottable: y("MIT"),
      },
      {
      ...
      { feature: "Unlimited developer seats", flexmonster: y(), reactPivottable: y() },
      {
        ...
        flexmonster: y("30 days, no signup"),
        reactPivottable: y("N/A — free"),
      },
      {
        feature: "No runtime licence key needed",
        flexmonster: n("Key validated client-side"),
        reactPivottable: y(),
      },
    ],
  },
